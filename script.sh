...
| mongoimport --host carbon/localhost:27001,localhost:27002,localhost:27003 \
      --drop -d test -c alarms --type csv --headerline) > replica1/"$i.txt" 2>&1
...
for ((i=1; $i<= 5;i++)) ; do
	(time unzip -c $dane \
| mongoimport --host carbon/localhost:27001,localhost:27002,localhost:27003 \
      --drop -d test -c alarms --type csv --headerline --writeConcern '{w:1, j:false}') > replica2/"$i.txt" 2>&1
...
for ((i=1; $i<= 5;i++)) ; do
	(time unzip -c $dane \
| mongoimport --host carbon/localhost:27001,localhost:27002,localhost:27003 \
      --drop -d test -c alarms --type csv --headerline --writeConcern '{w:1, j:true}') > replica3/"$i.txt" 2>&1
...
for ((i=1; $i<= 5;i++)) ; do
	(time unzip -c $dane \
| mongoimport --host carbon/localhost:27001,localhost:27002,localhost:27003 \
      --drop -d test -c alarms --type csv --headerline --writeConcern '{w:2, j:false}') > replica4/"$i.txt" 2>&1
...
for ((i=1; $i<= 5;i++)) ; do
	(time unzip -c $dane \
| mongoimport --host carbon/localhost:27001,localhost:27002,localhost:27003 \
      --drop -d test -c alarms --type csv --headerline --writeConcern '{w:2, j:true}') > replica5/"$i.txt" 2>&1
